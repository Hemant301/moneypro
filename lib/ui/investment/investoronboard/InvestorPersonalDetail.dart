...
class InvestorPersonalDetail extends StatefulWidget {
  const InvestorPersonalDetail({Key? key}) : super(key: key);

  @override
  _InvestorPersonalDetailState createState() => _InvestorPersonalDetailState();
}

class _InvestorPersonalDetailState extends State<InvestorPersonalDetail> {
  var screen = "Investor PD";
  ...
  getUserDetails() async {
    ...
    if (adhar.toString() == "" || adhar.toString() == "null") {
      adhar = "";
      setState(() {
        enableAdhar = true;
      });
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "DOB",
                        style: TextStyle(color: lightBlack, fontSize: font10.sp),
                      ),
                      SizedBox(
                        height: 2.h,
                      ),
