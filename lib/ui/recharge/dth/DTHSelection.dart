...
class DTHSelection extends StatefulWidget {
  ...
  @override
  _DTHSelectionState createState() => _DTHSelectionState();
}

class _DTHSelectionState extends State<DTHSelection> {
...
/*Stack(
      ...
      setState(() {
        ...
        if (status.toString() == "1") {
          ...
          for (int i = 0; i < billerList.length; i++) {
            printMessage(screen, "ICON URL : $billerIconUrl${billerList[i].icon}");
          }
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            ...
            style: TextStyle(
                color: black, fontSize: font16, fontWeight: FontWeight.w700),
          ),
        ),
      ],
    );
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: Text(
                                  currentBillerList[index].billerName,
                                  style:
                                      TextStyle(color: black, fontSize: font15),
                                ),
                              )
                            ],
                          ),
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              onTap: () {
                                ...
                                printMessage(screen,
                                    "Image url : $billerIconUrl${billerList[index].icon}");

                                if (billerList[index].billerName.toString() ==
                                    "Dish TV") {
                                  //25
                                  setState(() {
                                    dthCode = "25";
                                    operatorSecCode = "DTD";
                                    operatorSecName = "Dish TV";
                                    billerImg = "1629717789.jpg";
                                  });
                                } else if (billerList[index]
                                        .billerName
                                        .toString() ==
                                    "Tata Sky") {
                                  //28
                                  setState(() {
                                    dthCode = "28";
                                    operatorSecCode = "TSD";
                                    operatorSecName = "Tata Sky";
                                    billerImg = "1629717199.jpg";
                                  });
                                } else if (billerList[index]
                                        .billerName
                                        .toString() ==
                                  ...
                                  setState(() {
                                    dthCode = "27";
                                    operatorSecCode = "SD";
                                    operatorSecName = "Sun Direct";
                                    billerImg = "1629717684.jpg";
                                  });
                                } else if (billerList[index]
                                        .billerName
                                        .toString() ==
                                  ...
                                  setState(() {
                                    dthCode = "29";
                                    operatorSecCode = "VDD";
                                    operatorSecName = "Videocon DTH";
                                    billerImg = "1629717132.jpg";
                                  });
                                } else if (billerList[index]
                                        .billerName
                                        .toString() ==
                                  ...
                                  setState(() {
                                    dthCode = "24";
                                    operatorSecCode = "ATD";
                                    operatorSecName = "Airtel Digital TV";
                                    billerImg = "1629718240.jpg";
                                  });
                                }
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () {
                              ...
                              printMessage(screen,
                                  "Image url : $billerIconUrl${billerListFilterd[index].icon}");

                              if (billerListFilterd[index].billerName.toString() ==
                                  "Dish TV") {
                                //25
                                setState(() {
                                  dthCode = "25";
                              ...
                              } else if (billerListFilterd[index]
                                  .billerName
                                  .toString() ==
                                  "Tata Sky") {
                                //28
                              ...
                              Map map = {
                                ...
                                "stateCode": "$stateCode",
                                "operatorSecName": "$operatorSecName",
                                "billerImg": "${billerListFilterd[index].icon}",
                                "dthCode": "$dthCode",
                                "stateName": "$stateName",
                                "inputNo":""
                              };
  ...
  Future getOperatorsList() async {
    ...
    if(statusCode==200){
      var data = Operators.fromJson(jsonDecode(utf8.decode(response.bodyBytes)));

      printMessage(screen, "Response Operator : ${data}");
  ...
  Future getCircleList() async {
    ...
    printMessage(screen, "Response City : ${data}");
    ...
    setState(() {
      ...
      if (stateList.length != 0) {
        for (int i = 0; i < stateList.length; i++) {
          ...
          if (stateN.toLowerCase() == "$currentState".toLowerCase()) {
        ...
        printMessage(screen, "State Code : $stateCode");
      }
    });
  }
              ...
              onTap: () {
                ...
                for (int k = 0; k < billerList.length; k++) {
                  ...
                  if (opName == biName) {
                    ...
                    if (billerList[k].billerName.toString() ==
                        "Dish TV") {
                      //25
                      setState(() {
                        dthCode = "25";
                    ...
                    Map map = {
                      ...
                      "billerName":
                      "${billerList[k].billerName}",
                      "paramName": "${billerList[k].paramName}",
                      "paramName_1":
                      "${billerList[k].paramName1}",
                      "paramName_2":
                      "${billerList[k].paramName2}",
                      "paramName_3":
                      "${billerList[k].paramName3}",
                      "paramName_4":
                      "${billerList[k].paramName4}",
                      "icon": "${billerList[k].icon}",
                      "isAdhoc": "${billerList[k].isAdhoc}",
                      "fetchOption":
                      "${billerList[k].fetchOption}",
