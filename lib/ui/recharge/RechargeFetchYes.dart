...
class RechargeFetchYes extends StatefulWidget {
  ...
  const RechargeFetchYes({Key? key, required this.map}) : super(key: key);

  @override
  _RechargeFetchYesState createState() => _RechargeFetchYesState();
}
...
class _RechargeFetchYesState extends State<RechargeFetchYes> {
  ...
  createOrderForUPI(id, rechargeValue) async {
    ...
    printMessage(screen, "Cash free body : $body");
