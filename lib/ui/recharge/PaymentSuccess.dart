...
class PaymentSuccess extends StatefulWidget {
  ...
  const PaymentSuccess({Key? key,required this.map, required this.isShowDialog}) : super(key: key);
...
class _PaymentSuccessState extends State<PaymentSuccess>  with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    Timer(Duration(seconds: 2), () {
      if(widget.isShowDialog && widget.map['commission'].toString() !="0" && widget.map['commission'].toString() !=""){
        cashbackPopup();
      }
    });
  }
  ...
  cashbackPopup() {
    showModalBottomSheet(
        ...
        backgroundColor: Colors.transparent,
        builder: (context) => ShowCashback(commission: widget.map['commission'].toString(),id: "",));
  }
}
