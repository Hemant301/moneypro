...
class ATMOnBoarding extends StatefulWidget {
  const ATMOnBoarding({Key? key}) : super(key: key);

  @override
  _ATMOnBoardingState createState() => _ATMOnBoardingState();
}

class _ATMOnBoardingState extends State<ATMOnBoarding> {

  var screen = "ATM on Boarding";
  ...
  Future _getCryptRegister() async {
    ...
    if (Platform.isAndroid) {
      ...
      setState(() {
        ...
        printMessage(screen, "Result : ${data}");
  ...
  Future addMId(id) async {
    ...
    openATMKycProcess(context, authToken, id);
  }
}
