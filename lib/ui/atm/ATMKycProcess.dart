...
class ATMKycProcess extends StatefulWidget {
  ...
  final String mATMId;
  const ATMKycProcess({Key? key, required this.authToken, required this.mATMId})
      : super(key: key);
                        ...
                        child: Column(
                            ...
                            Center(
                              child: InkWell(
                                onTap: () {
                                  printMessage(
                                      "screen", "selectCatPos : $selectCatPos");
                                  if (selectCatPos.toString() ==
                                      "Select device") {
                                ...
                                child: Container(
                                  ...
                                  child: Icon(
                                    ...
                                    size: 72,
                                    color:
                                        (isFingerCapture) ? green : lightBlue,
                                  ),
                                ),
                              ),
                            ),
