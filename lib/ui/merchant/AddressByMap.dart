...
class AddressByMap extends StatefulWidget {
  final Map itemResponse;

  const AddressByMap({Key? key, required this.itemResponse}) : super(key: key);

  @override
  _AddressByMapState createState() => _AddressByMapState();
}

class _AddressByMapState extends State<AddressByMap> {
  ...
  _getCurrentLocation() {
    geolocator
      ...
      setState(() {
        ...
        printMessage(screen, "Position : $position");
