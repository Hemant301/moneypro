...
class DematDetails extends StatefulWidget {
  ...
  const DematDetails({Key? key,required this.fileName}) : super(key: key);
...
class _DematDetailsState extends State<DematDetails>  {
  ...
  Future getData()async{
    ...
    printMessage(screen, "MY Data : ${jsonResponse}");
    setState(() {
      loading=false;
    });
  }
          ...
          child: Column(
            ...
            children: [
              ...
              ListView.builder(
                  ...
                  itemCount: jsonResponse['benefits']['howWork'].length,
                  shrinkWrap: true,
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            flex: 1,
                            child: Text(
                              "${jsonResponse['benefits']['howWork'][index]}",
                              style: TextStyle(
                                  color: black,
                                  fontSize: font14.sp,
                                  fontWeight: FontWeight.normal),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ListView.builder(
                  itemCount: jsonResponse['benefits']['tnc'].length,
                  shrinkWrap: true,
                  physics: ScrollPhysics(),
                  itemBuilder: (context, index){
                    return Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            flex: 1,
                            child: Text(
                              "${jsonResponse['benefits']['tnc'][index]}",
                              style: TextStyle(
                                  color: black,
                                  fontSize: font14.sp,
                                  fontWeight: FontWeight.normal),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ListView.builder(
                  itemCount: jsonResponse['benefits']['keys'].length,
                  shrinkWrap: true,
                  physics: ScrollPhysics(),
                  itemBuilder: (context, index){
                    return Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            flex: 1,
                            child: Text(
                              "${jsonResponse['benefits']['keys'][index]}",
                              style: TextStyle(
                                  color: black,
                                  fontSize: font14.sp,
                                  fontWeight: FontWeight.normal),
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 15.0, top: 10, right: 15),
                child: Text(
                  "${jsonResponse['benefits']['location']}",
                  style: TextStyle(
                      color: black,
                      fontSize: font14.sp,),
                ),
