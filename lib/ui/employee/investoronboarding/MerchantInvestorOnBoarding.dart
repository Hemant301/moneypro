...
class MerchantInvestorOnBoarding extends StatefulWidget {
  final String token;
  const MerchantInvestorOnBoarding({Key? key, required this.token})
      : super(key: key);

  @override
  _MerchantInvestorOnBoardingState createState() =>
      _MerchantInvestorOnBoardingState();
}

class _MerchantInvestorOnBoardingState
    extends State<MerchantInvestorOnBoarding> {
                      ...
                      child: DropdownButton<String>(
                        ...
                        hint: Padding(
                          ...
                          child: Text(
                            selectCatPos,
                            style:
                                TextStyle(color: lightBlack, fontSize: font16),
                          ),
                        ),
                        icon: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              "DOB",
                              style: TextStyle(
                                  color: lightBlack, fontSize: font10),
                            ),
                            SizedBox(
                              height: 2,
                            ),
  ...
  Future saveInvestorPersonalDetails(title, mobile, fname, lname, email, pan,
      adhar, dob, address, street1, street2, city, pin) async {
    setState(() {
      showDialog(
