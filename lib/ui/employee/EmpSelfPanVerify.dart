...
class EmpSelfPanVerify extends StatefulWidget {
  const EmpSelfPanVerify({Key? key}) : super(key: key);

  @override
  _EmpSelfPanVerifyState createState() => _EmpSelfPanVerifyState();
}

class _EmpSelfPanVerifyState extends State<EmpSelfPanVerify> {
  final panController = new TextEditingController();
  TextEditingController panNameController = new TextEditingController();

  var screen = "Emp Self PAN";
          ...
          bottomNavigationBar: InkWell(
            onTap: () {
              setState(() {
                ...
                openEmpSelfBankDetails(context, newItem);
              });
            },
            child: Container(
              height: 45,
